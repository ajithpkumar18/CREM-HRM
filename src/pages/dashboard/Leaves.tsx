...
const Leaves: React.FC = () => {
  ...
  const [employeeLeaveData, setEmployeeLeaveData] = useState<EmployeeLeaveSummary[]>(EmployeeLeaveData); // Initialize with imported data
  ...
  return (
    <div className="flex h-screen"> {/* Removed bg-gray-100 from here */}
      <Sidebar /> {/* Assuming Sidebar handles its own width and background */}
